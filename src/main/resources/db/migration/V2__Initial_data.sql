...
VALUES (1, 'John', 'Doe', '1980-01-15', 'john.doe@example.com', '555-0101', '123 Elm St, Springfield', 750),
       ...
       (6, 'Ella', 'Fitzgerald', '1999-03-28', 'ella.fitzgerald@example.com', '555-0606', '103 Cedar St, Lakeview',
        815),
       (7, 'Miles', 'Davis', '1988-09-16', 'miles.davis@example.com', '555-0707', '201 Spruce St, Hilltown', 640),
       (8, 'Louis', 'Armstrong', '1982-02-01', 'louis.armstrong@example.com', '555-0808', '202 Redwood St, Coastside',
        710),
       ...
       (11, 'Billie', 'Holiday', '1994-06-17', 'billie.holiday@example.com', '555-1111', '501 Cherry St, Eastside',
        690),
       ...
       (15, 'Oscar', 'Peterson', '1991-07-15', 'oscar.peterson@example.com', '555-1515', '901 Spruce St, Centerville',
        770);



INSERT INTO financial_info (id,
                            monthly_income,
                            monthly_obligations,
                            marital_status,
                            employment_status,
                            employment_term,
                            dependants)
VALUES (1, 5000.00, 200.00, 'SINGLE', 'FULL_TIME', 5, 0),
...
INSERT INTO application (id,
                         ...
                         monthly_payment,
                         agreement_fee)
VALUES (1,1, 1, NULL, 25000.00, 5000.00, 10000.00, 5, 4.5, 'SIGNED', '2023-01-01', '2023-04-01', 350.00, 200.00),
       (2,2, 2, 1, 18000.00, 3600.00, 7200.00, 3, 3.9, 'PENDING_CHANGES', '2023-01-15', '2023-04-01', 450.00, 150.00),
       (3,3, 3, 2, 22000.00, 4400.00, 8800.00, 4, 4.0, 'SIGNED', '2023-02-01', '2023-04-01', 500.00, 250.00),
       (4,4, 4, 2, 15000.00, 3000.00, 6000.00, 3, 5.0, 'SIGNED', '2023-02-20', '2023-04-01', 380.00, 100.00),
       (5,5, 5, 3, 32000.00, 6400.00, 12800.00, 6, 3.5, 'PENDING_CHANGES', '2023-03-05', '2023-04-01', 460.00, 300.00),
       (6,6, 6, 3, 36000.00, 7200.00, 14400.00, 7, 4.2, 'REJECTED', '2023-03-15', '2023-04-01', 470.00, 350.00),
       (7,7, 7, 4, 20000.00, 4000.00, 8000.00, 5, 4.8, 'SIGNED', '2023-03-25', '2023-04-01', 340.00, 200.00),
       (8,8, 8, 4, 24000.00, 4800.00, 9600.00, 6, 3.6, 'REJECTED', '2023-04-01', '2023-04-01', 390.00, 240.00),
       (9,9, 9, 5, 27000.00, 5400.00, 10800.00, 5, 4.4, 'PENDING_CHANGES', '2023-04-10', '2023-04-10', 510.00, 270.00),
       (10,10, 10, 5, 30000.00, 6000.00, 12000.00, 5, 3.7, 'SIGNED', '2023-04-15', '2023-04-15', 540.00, 300.00),
       (11,11, 11, 6, 40000.00, 8000.00, 16000.00, 7, 4.0, 'SIGNED', '2023-04-01', '2023-04-01', 550.00, 400.00),
       (12,12, 12, 6, 35000.00, 7000.00, 14000.00, 6, 3.5, 'REJECTED', '2023-04-02', '2023-04-02', 480.00, 350.00),
       (13,13, 13, 7, 25000.00, 5000.00, 10000.00, 4, 4.5, 'PENDING_CHANGES', '2023-04-03', '2023-04-03', 430.00, 250.00),
       (14,14, 14, 7, 45000.00, 9000.00, 18000.00, 5, 3.9, 'SIGNED', '2023-04-04', '2023-04-04', 590.00, 450.00),
       (15,15, 15, 8, 37000.00, 7400.00, 14800.00, 6, 4.3, 'PENDING_CHANGES', '2023-04-05', '2023-04-05', 560.00, 370.00);
...
INSERT INTO application_status_history (application_id, status, changed_by_manager_id, changed_at)
VALUES (1, 'SUBMITTED', 1, '2023-01-02 10:00:00'),
       (1, 'UNDER_REVIEW', 1, '2023-01-09 10:00:00'),
       (1, 'SIGNED', 1, '2023-01-16 11:00:00'),
       (3, 'SUBMITTED', 3, '2023-02-02 09:30:00'),
       (3, 'UNDER_REVIEW', 3, '2023-02-15 09:30:00'),
       (3, 'CANCELLED', 3, '2023-02-21 08:45:00'),
       (5, 'UNDER_REVIEW', 9, '2023-03-06 12:30:00'),
       (6, 'UNDER_REVIEW', 2, '2023-03-16 14:50:00'),
       (7, 'UNDER_REVIEW', 4, '2023-03-26 10:20:00'),
       (8, 'UNDER_REVIEW', 6, '2023-04-02 10:30:00'),
       (9, 'UNDER_REVIEW', 8, '2023-04-11 16:40:00'),
       (10, 'UNDER_REVIEW', 1, '2023-04-16 15:30:00');
...
--
-- INSERT INTO application_status_history (application_id, status, changed_by_manager_id, changed_at)
-- VALUES (1, 'UNDER_REVIEW', 1, '2023-01-02 10:00:00'),
--        (1, 'WAITING_FOR_SIGNING', 2, '2023-01-10 15:00:00'),
--        (2, 'UNDER_REVIEW', 3, '2023-01-16 11:00:00'),
--        (2, 'WAITING_FOR_SIGNING', 4, '2023-01-25 16:00:00'),
--        (3, 'UNDER_REVIEW', 5, '2023-02-02 09:30:00'),
--        (3, 'REJECTED', 6, '2023-02-10 14:45:00'),
--        (4, 'UNDER_REVIEW', 7, '2023-02-21 08:45:00'),
--        (4, 'WAITING_FOR_SIGNING', 8, '2023-02-28 13:20:00'),
--        (5, 'UNDER_REVIEW', 9, '2023-03-06 12:30:00'),
--        (5, 'REJECTED', 1, '2023-03-12 11:15:00'),
--        (6, 'UNDER_REVIEW', 2, '2023-03-16 14:50:00'),
--        (6, 'WAITING_FOR_SIGNING', 3, '2023-03-25 15:10:00'),
--        (7, 'UNDER_REVIEW', 4, '2023-03-26 10:20:00'),
--        (7, 'REJECTED', 5, '2023-04-01 09:00:00'),
--        (8, 'UNDER_REVIEW', 6, '2023-04-02 10:30:00'),
--        (8, 'WAITING_FOR_SIGNING', 7, '2023-04-10 14:30:00'),
--        (9, 'UNDER_REVIEW', 8, '2023-04-11 16:40:00'),
--        (9, 'WAITING_FOR_SIGNING', 9, '2023-04-15 10:50:00'),
--        (10, 'UNDER_REVIEW', 1, '2023-04-16 15:30:00'),
--        (10, 'REJECTED', 2, '2023-04-20 14:20:00');
--
--
--
